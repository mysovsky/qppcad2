...
namespace qpp {
  ...
  namespace cad {
    ...
    static std::map<sp_u_name, std::string> map_u2s = {
      ...
      std::make_pair(sp_u_name::f_color1_alpha,        "f_color1_alpha"),
      std::make_pair(sp_u_name::f_color2_alpha,        "f_color2_alpha"),
    ...
    static std::map<sp_u_name, sp_u_type> map_u2at = {
      ...
      std::make_pair(sp_u_name::f_color1_alpha,        sp_u_type::a_sf),
      std::make_pair(sp_u_name::f_color2_alpha,        sp_u_type::a_sf),
